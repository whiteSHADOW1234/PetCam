...
// 如果不打算在 main/wifi_config.h 中而是在這裡設定 Wi-Fi SSID 和密碼，請註解掉下面這行。
#include "wifi_config.h"

// 請根據實際情況修改 Wi-Fi SSID 和密碼
#ifndef WIFI_CONFIG_H
#define WIFI_CONFIG_H

#define EXAMPLE_ESP_WIFI_SSID "YOUR_WIFI_SSID"      // 你的 Wi-Fi 名稱
#define EXAMPLE_ESP_WIFI_PASS "YOUR_WIFI_PASSWORD"  // 你的 Wi-Fi 密碼
